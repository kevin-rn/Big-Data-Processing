...
# 14 book
# 10 cover
mostCommonWords=$(cat * | grep -oE '[[:alpha:]]+' | sort -f| uniq -ic | sort -k1,1nr -k2 | head -10 | tr '[:upper:]' '[:lower:]')
...
fixedBook=$(cat * | sed 's/\ i /\ I /g' | sed 's/\“i /\“I /g' | sed 's/\"i /\"I /g')
